...
app.controller("AppCtrl", function ($http, $scope){
    ...
    $http.get('http://localhost:8080/request/request1_4?countRoom_id='+countRoom_id+'&firstDate='+date1+'&secondDate='+
    date2).then(function (response){
        $scope.request1_4=response.data;
    ...
    this.update_request = function add() {
        ...
        $http.get('http://localhost:8080/request/request1_4?countRoom_id='+countRoom_id+'&firstDate='+date1+'&secondDate='+date2).then(function (response){
            $scope.request1_4=response.data;
            console.log(response);
        });
    };
