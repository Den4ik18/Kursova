...
app.controller("AppCtrl", function ($http, $scope){
    ...
    $http.get('/request/request1_3?countRoom_id='+countRoom_id+'&firstDate='+date1+'&secondDate='+
    ...
    this.update_request = function add() {
        ...
        $http.get('/request/request1_3?countRoom_id='+countRoom_id+'&firstDate='+date1+'&secondDate='+date2).then(function (response){
            $scope.request1_3=response.data;
            console.log(response);
        });
    };
