...
app.controller("AppCtrl", function ($http, $scope){
    ...
    //var building_id=1;
    var building_id=2;
    $http.get('http://localhost:8080/request/request2_1?building_id='+building_id+'&firstDate='+date1+'&secondDate='+
    ...
    this.update_request = function add() {
        ...
        $http.get('http://localhost:8080/request/request2_1?building_id='+building_id+'&firstDate='+date1+'&secondDate='+date2).then(function (response){
            $scope.request2_1=response.data;
            console.log(response);
        });
    };
